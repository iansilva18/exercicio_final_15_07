...
class Estoque:
    ...
    def salvar_produtos(self):
        if len(self.listaFabricantes) > 0:
            ...
            print('Não existe fabricante cadastrado.')
    ...
    def listar_produtos(self):
        ...
        if x == '2':
            in_cod = input('Insira codigo do produto.\n: ')
            if in_cod == '':
                self.mostrar_produtos()
            contador = 0
    ...
    def alterar_fabricantes(self):
        self.mostrar_fabricantes()
        in_cod = input('Insira o codigo do fabricante.\n: ')
        for i in range(len(self.listaFabricantes)):
    ...
    def alterar_produtos(self):
        self.mostrar_produtos()
        in_cod = input('Insira o codigo do produto.\n: ')
        for i in range(len(self.listaProdutos)):
            if self.listaProdutos[i].cod == in_cod:
    ...
    def mostrar_fabricantes(self):
        print('Fabricantes')
        for i in range(len(self.listaFabricantes)):
            print('Codigo: ', self.listaFabricantes[i].cod,
